...
pdf("CD4 and CD8 ratio.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4_T_Cells_per_gram, y = cd8_T_Cells_per_gram, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4 T Cells per gram") + ylab("CD8 T Cells per gram") + ylim(0,5000000) +xlim(0,5000000) +stat_cor(method = "pearson")
    dev.off()
```
