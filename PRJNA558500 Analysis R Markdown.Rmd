...
ggplot(herv_Category, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = AvgCount, fill = reorder(Category, -AvgCount))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "HERV Category")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
...
#class
pdf("group_class.pdf")
ggplot(herv_Class, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = AvgCount, fill = reorder(Class, -AvgCount))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "TE Class")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
#chrom
pdf("group_chrom.pdf")
ggplot(herv_Chrom, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = AvgCount, fill = reorder(Chrom, -AvgCount))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "TE Chrom")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
#TE_type
pdf("TE_type.pdf")
ggplot(TE_type, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = AvgCount, fill = reorder(TE_type, -AvgCount))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "TE type")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
ggplot(herv_Category, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = PCT, fill = reorder(Category, -PCT))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "HERV Category")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
ggplot(herv_Class, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = PCT, fill = reorder(Class, -PCT))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "TE Class")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
ggplot(herv_Chrom, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = PCT, fill = reorder(Chrom, -PCT))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "TE Chrom")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
#TE_typePCT
pdf("TE_type_pct.pdf")
ggplot(TE_type, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = PCT, fill = reorder(TE_type, -PCT))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "TE type")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
#familyPCT
pdf("group_family_pct.pdf")
ggplot(herv_Family, aes(x = factor(disease, levels = c("HIVneg", "HIVpos")), y = PCT, fill = reorder(Family, -PCT))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("HIV Status")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "TE Family")) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
```{r}
#"Library.Name_a1_vs_m"  "Library.Name_a14_vs_m" "Library.Name_a2_vs_m"  "Library.Name_a5_vs_m" "Library.Name_a8_vs_m"  "Library.Name_b_vs_m" 

#upregulated
res_herv_pm_a1_vs_m_up <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a1_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= 1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a2_vs_m_up <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a2_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= 1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a5_vs_m_up <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a5_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= 1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a8_vs_m_up <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a8_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= 1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a14_vs_m_up <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a14_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= 1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_b_vs_m_up <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_b_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= 1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

#downregulated
res_herv_pm_a1_vs_m_down <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a1_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= -1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a2_vs_m_down <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a2_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= -1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a5_vs_m_down <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a5_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= -1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a8_vs_m_down <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a8_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= -1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_a14_vs_m_down <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_a14_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= -1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

res_herv_pm_b_vs_m_down <- results(dds_Interferome, independentFiltering = TRUE, name = "Library.Name_b_vs_m") %>% as.data.frame(.)  %>% dplyr::select(everything()) %>%
    filter(log2FoldChange >= -1) %>%
    filter(pvalue <= 0.05) %>%
    arrange(pvalue) %>% rownames()

#upregulated vs m
ggVennUp <- list(res_herv_pm_a1_vs_m_up, res_herv_pm_a2_vs_m_up, res_herv_pm_a5_vs_m_up, res_herv_pm_a14_vs_m_up, res_herv_pm_b_vs_m_up)


pdf("Upregulated TEs Interferome.pdf")

ggVennDiagram(ggVennUp, label = "count", category.names = c("IFNa1","IFNa2","IFNa5", "IFNa14", "IFNb")) + scale_fill_gradient(low = "#F4FAFE", high = "#56fb0e")

dev.off()

#downregulated vs m
ggVennDown <- list(res_herv_pm_a1_vs_m_down, res_herv_pm_a2_vs_m_down, res_herv_pm_a5_vs_m_down, res_herv_pm_a14_vs_m_down, res_herv_pm_b_vs_m_down)

pdf("Downregulated TEs Interferome.pdf")

ggVennDiagram(ggVennDown, label = "count", category.names = c("IFNa1","IFNa2","IFNa5", "IFNa14", "IFNb")) + scale_fill_gradient(low = "#F4FAFE", high = "#ff2f2f")
...
pdf("Heatmap gut sig.pdf")
pheatmap(dfGut, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = TRUE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta[,"disease",drop = FALSE])

dev.off()

pdf("Heatmap gut all.pdf")
pheatmap(dfGutAll, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta[,"disease",drop = FALSE])
...
pdf("Heatmap Interferome all.pdf")
dfSigAll_clust <- dfSigAll[, rownames(meta_int)[order(meta_int$Library.Name)]]
pheatmap(dfSigAll_clust, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta_int[,"Library.Name",drop = FALSE])

dev.off()

pdf("Heatmap Interferome a1.pdf")
dfSiga1_clust <- dfSiga1[, rownames(meta_int)[order(meta_int$Library.Name)]]
dfSiga1_clust <- data.frame(dfSiga1_clust[, c("SRR9904874", "SRR9904876", "SRR9904885", "SRR9904875", "SRR9904882", "SRR9904877")])
pheatmap(dfSiga1_clust, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta_int[,"Library.Name",drop = FALSE])

dev.off()

pdf("Heatmap Interferome a2.pdf")
dfSiga2_clust <- dfSiga2[, rownames(meta_int)[order(meta_int$Library.Name)]]
dfSiga2_clust <- data.frame(dfSiga2_clust[, c("SRR9904873", "SRR9904879", "SRR9904884", "SRR9904875", "SRR9904882", "SRR9904877")])
pheatmap(dfSiga2_clust, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta_int[,"Library.Name",drop = FALSE])

dev.off()

pdf("Heatmap Interferome a5.pdf")
dfSiga5_clust <- dfSiga5[, rownames(meta_int)[order(meta_int$Library.Name)]]
dfSiga5_clust <- data.frame(dfSiga5_clust[, c("SRR9904871", "SRR9904872", "SRR9904878", "SRR9904875", "SRR9904882", "SRR9904877")])
pheatmap(dfSiga5_clust, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta_int[,"Library.Name",drop = FALSE])

dev.off()

pdf("Heatmap Interferome a8.pdf")
dfSiga8_clust <- dfSiga8[, rownames(meta_int)[order(meta_int$Library.Name)]]
dfSiga8_clust <- data.frame(dfSiga8_clust[, c("SRR9904867", "SRR9904881", "SRR9904870", "SRR9904875", "SRR9904882", "SRR9904877")])
pheatmap(dfSiga8_clust, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta_int[,"Library.Name",drop = FALSE])

dev.off()

pdf("Heatmap Interferome a14.pdf")
dfSiga14_clust <- dfSiga14[, rownames(meta_int)[order(meta_int$Library.Name)]]
dfSiga14_clust <- data.frame(dfSiga14_clust[, c("SRR9904866", "SRR9904869", "SRR9904880", "SRR9904875", "SRR9904882", "SRR9904877")])
pheatmap(dfSiga14_clust, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta_int[,"Library.Name",drop = FALSE])

dev.off()

pdf("Heatmap Interferome b.pdf")
dfSigb_clust <- dfSigb[, rownames(meta_int)[order(meta_int$Library.Name)]]
dfSigb_clust <- data.frame(dfSigb_clust[, c("SRR9904886", "SRR9904883", "SRR9904868", "SRR9904875", "SRR9904882", "SRR9904877")])
pheatmap(dfSigb_clust, scale="row",main = "Title",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta_int[,"Library.Name",drop = FALSE])
