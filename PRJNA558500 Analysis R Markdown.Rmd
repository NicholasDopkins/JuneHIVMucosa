...
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + stat_compare_means(method = "t.test", label.x.npc = "center", label.y.npc = "top", size = 2.5)}
  else{
    herv_plot <- ggplot(count_hervs, aes(x = Category, y = HERV, color = Category)) + geom_boxplot(outlier.shape = NA)+ geom_jitter(size = 1, shape=16, position=position_jitter(0.2))+ stat_summary(fun.y=mean)+xlab(NULL)+ ylab(" Normalized Counts")+ggtitle(title)+theme(plot.title = element_text(size = 15, face = "bold"),axis.title=element_text(size=15,face="bold"),legend.title = element_text(size = 15,face="bold"),axis.text = element_text(size = 15),axis.text.x = element_text(angle = 60, vjust = 1, hjust=1))+ theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+ stat_compare_means(method = "anova",label.y.npc = "top", label.x.npc = "center", size = 2.5)+ stat_compare_means(label = "p.signif", method = "t.test",
                     ref.group = "m", label.y.npc = "bottom", hide.ns = TRUE, size = 3)
  }
...
herv_table_cd4a$L1FLnI_1p31.1nc <- as.numeric(herv_table_cd4a$L1FLnI_1p31.1nc)
  ...
  ggplot(herv_table_cd4a, aes(x=CD4a, y = L1FLnI_1p31.1nc, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl")
    dev.off()
...
herv_table_cd4a$L1FLnI_11p14.1v <- as.numeric(herv_table_cd4a$L1FLnI_11p14.1v)
  ...
  ggplot(herv_table_cd4a, aes(x=CD4a, y = L1FLnI_11p14.1v, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "pearson")
    dev.off()
  pdf("L1FLnI_11p14.1v Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_11p14.1v, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL")
    dev.off()
herv_table_cd4a$L1FLnI_4q21.21x <- as.numeric(herv_table_cd4a$L1FLnI_4q21.21x)
  ...
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_4q21.21x, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL")
    dev.off()
...
#6 TEs of further interest
#6 With best association between expression and CD4 Counts / Viral Load
#L1FLnI_1p22.2l, LTR19_12p13.31, L1FLnI_1q23.1t, HARLEQUIN_10q24.2, MER101_2p25.2, and HERVH_6q23.1
...
pdf("L1FLnI_1p22.2l Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "pearson")
    dev.off()
pdf("LTR19_12p13.31 Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "pearson")
    dev.off()
pdf("L1FLnI_1q23.1t Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "pearson")
    dev.off()
pdf("HARLEQUIN_10q24.2 Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "pearson")
    dev.off()
pdf("MER101_2p25.2 Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "pearson")
    dev.off()
pdf("HERVH_6q23.1 Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "pearson")
    dev.off()
```
#CD11c+ mDCs per gram
```{r}
#L1FLnI_1p22.2l, LTR19_12p13.31, L1FLnI_1q23.1t, HARLEQUIN_10q24.2, MER101_2p25.2, and HERVH_6q23.1
herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut CD11c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub, aes(x=CD11cpos_mDCs_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD11c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut CD11c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub, aes(x=CD11cpos_mDCs_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD11c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$HARLEQUIN_10q24.2)
pdf("HARLEQUIN_10q24.2 Gut CD11c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub, aes(x=CD11cpos_mDCs_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD11c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut CD11c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub, aes(x=CD11cpos_mDCs_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD11c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut CD11c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub, aes(x=CD11cpos_mDCs_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD11c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut CD1c- mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub, aes(x=CD1cneg_mDCs_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c- mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut CD1c- mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub, aes(x=CD1cneg_mDCs_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c- mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$HARLEQUIN_10q24.2)
pdf("HARLEQUIN_10q24.2 Gut CD1c- mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub, aes(x=CD1cneg_mDCs_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c- mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut CD1c- mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub, aes(x=CD1cneg_mDCs_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c- mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut CD1c- mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub, aes(x=CD1cneg_mDCs_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c- mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut CD1c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub, aes(x=CD1cpos_mDCs_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut CD1c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub, aes(x=CD1cpos_mDCs_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$HARLEQUIN_10q24.2)

pdf("HARLEQUIN_10q24.2 Gut CD1c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub, aes(x=CD1cpos_mDCs_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut CD1c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub, aes(x=CD1cpos_mDCs_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut CD1c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub, aes(x=CD1cpos_mDCs_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c+ mDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD4_T_Cells_per_gram_sub, aes(x=cd4_T_Cells_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD4_T_Cells_per_gram_sub, aes(x=cd4_T_Cells_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2)

pdf("HARLEQUIN_10q24.2 Gut CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD4_T_Cells_per_gram_sub, aes(x=cd4_T_Cells_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD4_T_Cells_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_CD4_T_Cells_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD4_T_Cells_per_gram_sub, aes(x=cd4_T_Cells_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD4_T_Cells_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_CD4_T_Cells_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD4_T_Cells_per_gram_sub, aes(x=cd4_T_Cells_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_CD8_T_Cells_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_CD8_T_Cells_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD8_T_Cells_per_gram_sub, aes(x=cd8_T_Cells_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_CD8_T_Cells_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_CD8_T_Cells_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD8_T_Cells_per_gram_sub, aes(x=cd8_T_Cells_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD8_T_Cells_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_CD8_T_Cells_per_gram_sub$HARLEQUIN_10q24.2)

pdf("HARLEQUIN_10q24.2 Gut CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD8_T_Cells_per_gram_sub, aes(x=cd8_T_Cells_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD8_T_Cells_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_CD8_T_Cells_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD8_T_Cells_per_gram_sub, aes(x=cd8_T_Cells_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_CD8_T_Cells_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_CD8_T_Cells_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD8_T_Cells_per_gram_sub, aes(x=cd8_T_Cells_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut IFNy-IL17+T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYnegIL17pos_CD4_T_Cells_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy-IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut IFNy-IL17+T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYnegIL17pos_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Gut IFNy-IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2)

pdf("HARLEQUIN_10q24.2 Gut IFNy-IL17+T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYnegIL17pos_CD4_T_Cells_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Gut IFNy-IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut IFNy-IL17+T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYnegIL17pos_CD4_T_Cells_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Gut IFNy-IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut IFNy-IL17+T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYnegIL17pos_CD4_T_Cells_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Gut IFNy-IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut IFNy+ CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub, aes(x=IFNYpos_cd8_T_Cells_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+ CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut IFNy+ CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub, aes(x=IFNYpos_cd8_T_Cells_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+ CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$HARLEQUIN_10q24.2)

pdf("HARLEQUIN_10q24.2 Gut IFNy+ CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub, aes(x=IFNYpos_cd8_T_Cells_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+ CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut IFNy+ CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub, aes(x=IFNYpos_cd8_T_Cells_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+ CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut IFNy+ CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub, aes(x=IFNYpos_cd8_T_Cells_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+ CD8+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut IFNy+IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17neg_CD4_T_Cells_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut IFNy+IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17neg_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2)

pdf("HARLEQUIN_10q24.2 Gut IFNy+IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17neg_CD4_T_Cells_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut IFNy+IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17neg_CD4_T_Cells_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut IFNy+IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17neg_CD4_T_Cells_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut IFNy+IL17+ T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17pos_CD4_T_Cells_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut IFNy+IL17+ T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17pos_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2)
pdf("HARLEQUIN_10q24.2 Gut IFNy+IL17+ T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17pos_CD4_T_Cells_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut IFNy+IL17+ T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17pos_CD4_T_Cells_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut IFNy+IL17+ T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17pos_CD4_T_Cells_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut IL22+IFNy-IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IL22+IFNy-IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut IL22+IFNy-IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IL22+IFNy-IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$HARLEQUIN_10q24.2)
pdf("HARLEQUIN_10q24.2 Gut IL22+IFNy-IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IL22+IFNy-IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut IL22+IFNy-IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IL22+IFNy-IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut IL22+IFNy-IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IL22+IFNy-IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_IL6_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_IL6_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Serum IL-6.pdf")
  ggplot(herv_table_cd4a_IL6_sub, aes(x=IL6, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum IL-6") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_IL6_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_IL6_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Serum IL-6.pdf")
  ggplot(herv_table_cd4a_IL6_sub, aes(x=IL6, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum IL-6") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IL6_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_IL6_sub$HARLEQUIN_10q24.2)
pdf("HARLEQUIN_10q24.2 Serum IL-6.pdf")
  ggplot(herv_table_cd4a_IL6_sub, aes(x=IL6, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum IL-6") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IL6_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_IL6_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Serum IL-6.pdf")
  ggplot(herv_table_cd4a_IL6_sub, aes(x=IL6, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum IL-6") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_IL6_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_IL6_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Serum IL-6.pdf")
  ggplot(herv_table_cd4a_IL6_sub, aes(x=IL6, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum IL-6") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_LPS_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_LPS_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Serum LPS.pdf")
  ggplot(herv_table_cd4a_LPS_sub, aes(x=LPS, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum LPS") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_LPS_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_LPS_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Serum LPS.pdf")
  ggplot(herv_table_cd4a_LPS_sub, aes(x=LPS, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum LPS") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_LPS_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_LPS_sub$HARLEQUIN_10q24.2)
pdf("HARLEQUIN_10q24.2 Serum LPS.pdf")
  ggplot(herv_table_cd4a_LPS_sub, aes(x=LPS, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum LPS") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_LPS_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_LPS_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Serum LPS.pdf")
  ggplot(herv_table_cd4a_LPS_sub, aes(x=LPS, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum LPS") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_LPS_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_LPS_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Serum LPS.pdf")
  ggplot(herv_table_cd4a_LPS_sub, aes(x=LPS, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum LPS") + stat_cor(method = "pearson")
    dev.off()
```
...
herv_table_cd4a_pDCs_per_gram_sub$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a_pDCs_per_gram_sub$L1FLnI_1p22.2l)
pdf("L1FLnI_1p22.2l Gut pDCs per gram.pdf")
  ggplot(herv_table_cd4a_pDCs_per_gram_sub, aes(x=pDCs_per_gram, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("pDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
...
herv_table_cd4a_pDCs_per_gram_sub$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a_pDCs_per_gram_sub$L1FLnI_1q23.1t)
pdf("L1FLnI_1q23.1t Gut pDCs per gram.pdf")
  ggplot(herv_table_cd4a_pDCs_per_gram_sub, aes(x=pDCs_per_gram, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("pDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_pDCs_per_gram_sub$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a_pDCs_per_gram_sub$HARLEQUIN_10q24.2)
pdf("HARLEQUIN_10q24.2 Gut pDCs per gram.pdf")
  ggplot(herv_table_cd4a_pDCs_per_gram_sub, aes(x=pDCs_per_gram, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("pDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_pDCs_per_gram_sub$MER101_2p25.2 <- as.numeric(herv_table_cd4a_pDCs_per_gram_sub$MER101_2p25.2)
pdf("MER101_2p25.2 Gut pDCs per gram.pdf")
  ggplot(herv_table_cd4a_pDCs_per_gram_sub, aes(x=pDCs_per_gram, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("pDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
    
herv_table_cd4a_pDCs_per_gram_sub$HERVH_6q23.1 <- as.numeric(herv_table_cd4a_pDCs_per_gram_sub$HERVH_6q23.1)
pdf("HERVH_6q23.1 Gut pDCs per gram.pdf")
  ggplot(herv_table_cd4a_pDCs_per_gram_sub, aes(x=pDCs_per_gram, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("pDCs per gram (colon)") + stat_cor(method = "pearson")
    dev.off()
```
