...
ddsf[which(ddsf$disease == ""),"disease"] <- "Control"
ddsf[which(ddsf$disease == "HIV-1"),"disease"] <- "PLWH"
...
resultsdds <- results(dds, name = "disease_PLWH_vs_Control")
```

##Make Volcano Plot Gut Biopsies
...
EnhancedVolcano::EnhancedVolcano(resultsdds, lab = rownames(resultsdds), x = 'log2FoldChange', y = 'padj', title = 'Controls vs PLWH Gut Biopsies', pCutoff = 0.05, FCcutoff = 1, labSize = 2.5,  labFace = 'bold', xlim = c(-4, 4), ylim = c(0, 15), colCustom = keyvals.colour)

dev.off()
```

##Make PCA Gut Biopsies
...
pdf("biplot.pdf")
biplot(p, lab = p$disease, labSize = 2, pointSize = 2, colby = 'disease', shape = 'Sex', legendTitleSize = 0, showLoadingsNames = TRUE, legendPosition = 'right', encircle = TRUE, xlim = c(-50,50), ylim = c(-60,60), title = 'Control vs PLWH Gut Biopsies') 
...
meta <- ddsf
meta[which(meta$disease == ""),"disease"] <- "Control"
meta[which(meta$disease == "HIV-1"),"disease"] <- "PLWH"
...
ggplot(herv_Category, aes(x = factor(disease, levels = c("Control", "PLWH")), y = AvgCount, fill = reorder(Category, -AvgCount))) + geom_bar(stat = "identity", size=0.1, colour = "white") + xlab("")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "HERV Category")) + scale_fill_brewer(palette="Paired") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
ggplot(herv_Class, aes(x = factor(disease, levels = c("Control", "PLWH")), y = AvgCount, fill = reorder(Class, -AvgCount))) + geom_bar(stat = "identity", size=0) + xlab("")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "TE Class")) + scale_fill_brewer(palette="Paired")  + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
ggplot(herv_Chrom, aes(x = factor(disease, levels = c("Control", "PLWH")), y = AvgCount, fill = reorder(Chrom, -AvgCount))) + geom_bar(stat = "identity", size=0) + xlab("")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "TE Chrom"))  + scale_fill_manual(values = mycolors_TE_Chromosomes)  + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
ggplot(TE_type, aes(x = factor(disease, levels = c("Control", "PLWH")), y = AvgCount, fill = reorder(TE_type, -AvgCount))) + geom_bar(stat = "identity", size=0) + xlab("")+ ylab("Average Count Per Sample") + guides(fill = guide_legend(title = "TE type")) + scale_fill_brewer(palette="Paired")  + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
ggplot(herv_Category, aes(x = factor(disease, levels = c("Control", "PLWH")), y = PCT, fill = reorder(Category, -PCT))) + geom_bar(stat = "identity", size=0) + xlab("")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "HERV Category")) + scale_fill_brewer(palette="Paired")  + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
ggplot(herv_Class, aes(x = factor(disease, levels = c("Control", "PLWH")), y = PCT, fill = reorder(Class, -PCT))) + geom_bar(stat = "identity", size=0) + xlab("")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "TE Class")) + scale_fill_brewer(palette="Paired")  + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
ggplot(herv_Chrom, aes(x = factor(disease, levels = c("Control", "PLWH")), y = PCT, fill = reorder(Chrom, -PCT))) + geom_bar(stat = "identity", size=0) + xlab("")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "TE Chrom")) + scale_fill_manual(values = mycolors_TE_Chromosomes) + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
ggplot(TE_type, aes(x = factor(disease, levels = c("Control", "PLWH")), y = PCT, fill = reorder(TE_type, -PCT))) + geom_bar(stat = "identity", size=0) + xlab("")+ ylab("Percent Abundance") + guides(fill = guide_legend(title = "TE type")) + scale_fill_brewer(palette="Paired")  + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(legend.key.size = unit(0.2, 'cm'), legend.text = element_text(size=6.8)) + theme(axis.text.x = element_text(face = "bold", hjust=1, angle = 50))
...
biplot(p_Interferome, lab = p_Interferome$Library.Name, labSize = 2, legendTitleSize = 0, pointSize = 2, colby = 'Library.Name', showLoadingsNames = TRUE, legendPosition = 'right', encircle = TRUE, xlim = c(-50,50), ylim = c(-50,50), title = 'IFN-I Activated Gut CD4+ T Cells')
...
ggVennDiagram(VennDown, label = "count", category.names = c("HIV gut biopsies", "IFNa1","IFNa2","IFNa5", "IFNa8", "IFNa14", "IFNb")) + scale_fill_gradient(low = "#F4FAFE", high = "#Ff6300")

dev.off()

pdf("Upregulated TEs Venn.pdf")

ggVennDiagram(VennUp, label = "count", category.names = c("HIV gut biopsies", "IFNa1","IFNa2","IFNa5", "IFNa8", "IFNa14", "IFNb")) + scale_fill_gradient(low = "#F4FAFE", high = "#063970")
...
annot_colors=list(disease=c(Control="#F0978D",PLWH="#63D7DE"))

pdf("Heatmap gut sig.pdf", height = 6, width = 4)
dfGut <- dfGut[, rownames(meta)[order(meta$disease)]]
pheatmap(dfGut, annotation_colors=annot_colors, scale="row",main = "Control vs PLWH Gut Biopsies",fontsize = 5, size = 35, show_colnames = FALSE, show_rownames = TRUE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta[,"disease",drop = FALSE], color = hcl.colors(10000, "RdYlBu"))

dev.off()

pdf("Heatmap gut all.pdf", height = 6, width = 4)
dfGutAll_clust <- dfGutAll[, rownames(meta)[order(meta$disease)]]
pheatmap(dfGutAll_clust, annotation_colors=annot_colors, scale="row",main = "Control vs PLWH Gut Biopsies",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = meta[,"disease",drop = FALSE], color = hcl.colors(10000, "RdYlBu"))
...
for(herv in herv_to_quantify){
  for(item in unique(meta$ï..Run)){
    ...
    cd4a <- meta[item,"CD4blood"]
    herv_table_cd4a[item,c("Run","CD4blood",herv)] <- c(item,cd4a,count_total)
  }
}
#cd4a is an arbitrary tag for the herv_table based on a previous iteration of code. It does NOT represent the marker CD4a in any shape or form
herv_table_cd4a$CD4blood <- as.numeric(herv_table_cd4a$CD4blood)
herv_table_cd4a$disease <- meta[rownames(herv_table_cd4a),"disease"]
herv_table_cd4a$cd4colon <- meta[rownames(herv_table_cd4a),"CD4colon"]
...
herv_table_cd4a$L1FLnI_4q35.2i <- as.numeric(herv_table_cd4a$L1FLnI_4q35.2i)
  ...
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_4q35.2i, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_4q35.2i Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_4q35.2i, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_4p16.3c <- as.numeric(herv_table_cd4a$L1FLnI_4p16.3c)
  pdf("L1FLnI_4p16.3c CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_4p16.3c, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_4p16.3c Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_4p16.3c, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1p13.1e <- as.numeric(herv_table_cd4a$L1FLnI_1p13.1e)
  pdf("L1FLnI_1p13.1e CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1p13.1e, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1p13.1e Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1p13.1e, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1p34.2a <- as.numeric(herv_table_cd4a$L1FLnI_1p34.2a)
  pdf("L1FLnI_1p34.2a CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1p34.2a, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1p34.2a Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1p34.2a, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1p22.2l <- as.numeric(herv_table_cd4a$L1FLnI_1p22.2l)
  pdf("L1FLnI_1p22.2l CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1p22.2l Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1p22.2l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$MER4_7q21.2 <- as.numeric(herv_table_cd4a$MER4_7q21.2)
  pdf("MER4_7q21.2 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = MER4_7q21.2, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("MER4_7q21.2 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = MER4_7q21.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$LTR19_12p13.31 <- as.numeric(herv_table_cd4a$LTR19_12p13.31)
  pdf("LTR19_12p13.31 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
  dev.off()
  pdf("LTR19_12p13.31 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$MER4B_19q13.42a <- as.numeric(herv_table_cd4a$MER4B_19q13.42a)
  pdf("MER4B_19q13.42a CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = MER4B_19q13.42a, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("MER4B_19q13.42a Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = MER4B_19q13.42a, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$MER101_2p25.2 <- as.numeric(herv_table_cd4a$MER101_2p25.2)
  pdf("MER101_2p25.2 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("MER101_2p25.2 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = MER101_2p25.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_17q12k <- as.numeric(herv_table_cd4a$L1FLnI_17q12k)
  pdf("L1FLnI_17q12k CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_17q12k, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_17q12k Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_17q12k, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1q23.1t <- as.numeric(herv_table_cd4a$L1FLnI_1q23.1t)
  pdf("L1FLnI_1q23.1t CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1q23.1t Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1q23.1t, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERVH_6q23.1 <- as.numeric(herv_table_cd4a$HERVH_6q23.1)
  pdf("HERVH_6q23.1 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERVH_6q23.1 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERVH_6q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1q23.1u <- as.numeric(herv_table_cd4a$L1FLnI_1q23.1u)
  pdf("L1FLnI_1q23.1u CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1q23.1u, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1q23.1u Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1q23.1u, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERVIP10F_12p13.2 <- as.numeric(herv_table_cd4a$HERVIP10F_12p13.2)
  pdf("HERVIP10F_12p13.2 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERVIP10F_12p13.2, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERVIP10F_12p13.2 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERVIP10F_12p13.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HARLEQUIN_10q24.2 <- as.numeric(herv_table_cd4a$HARLEQUIN_10q24.2)
  pdf("HARLEQUIN_10q24.2 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HARLEQUIN_10q24.2 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HARLEQUIN_10q24.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERVH48_2q22.2 <- as.numeric(herv_table_cd4a$HERVH48_2q22.2)
  pdf("HERVH48_2q22.2 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERVH48_2q22.2, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERVH48_2q22.2 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERVH48_2q22.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERVH_4p15.33d <- as.numeric(herv_table_cd4a$HERVH_4p15.33d)
  pdf("HERVH_4p15.33d CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERVH_4p15.33d, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERVH_4p15.33d Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERVH_4p15.33d, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HARLEQUIN_17q12 <- as.numeric(herv_table_cd4a$HARLEQUIN_17q12)
  pdf("HARLEQUIN_17q12 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HARLEQUIN_17q12, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HARLEQUIN_17q12 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HARLEQUIN_17q12, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_4p15.32e <- as.numeric(herv_table_cd4a$L1FLnI_4p15.32e)
  pdf("L1FLnI_4p15.32e CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_4p15.32e, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_4p15.32e Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_4p15.32e, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_3p24.1m <- as.numeric(herv_table_cd4a$L1FLnI_3p24.1m)
  pdf("L1FLnI_3p24.1m CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_3p24.1m, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_3p24.1m Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_3p24.1m, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$MER61_1q23.1c <- as.numeric(herv_table_cd4a$MER61_1q23.1c)
  pdf("MER61_1q23.1c CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = MER61_1q23.1c, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("MER61_1q23.1c Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = MER61_1q23.1c, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_Xq21.1hb <- as.numeric(herv_table_cd4a$L1FLnI_Xq21.1hb)
  pdf("L1FLnI_Xq21.1hb CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_Xq21.1hb, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_Xq21.1hb Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_Xq21.1hb, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_2q22.2k <- as.numeric(herv_table_cd4a$L1FLnI_2q22.2k)
  pdf("L1FLnI_2q22.2k CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_2q22.2k, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_2q22.2k Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_2q22.2k, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_12p13.31k <- as.numeric(herv_table_cd4a$L1FLnI_12p13.31k)
  pdf("L1FLnI_12p13.31k CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_12p13.31k, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_12p13.31k Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_12p13.31k, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERVEA_5q22.2 <- as.numeric(herv_table_cd4a$HERVEA_5q22.2)
  pdf("HERVEA_5q22.2 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERVEA_5q22.2, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERVEA_5q22.2 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERVEA_5q22.2, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERVH_7q11.21 <- as.numeric(herv_table_cd4a$HERVH_7q11.21)
  pdf("HERVH_7q11.21 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERVH_7q11.21, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERVH_7q11.21 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERVH_7q11.21, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_12p12.1r <- as.numeric(herv_table_cd4a$L1FLnI_12p12.1r)
  pdf("L1FLnI_12p12.1r CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_12p12.1r, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_12p12.1r Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_12p12.1r, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1q23.2i <- as.numeric(herv_table_cd4a$L1FLnI_1q23.2i)
  pdf("L1FLnI_1q23.2i CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1q23.2i, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1q23.2i Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1q23.2i, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_7p13a <- as.numeric(herv_table_cd4a$L1FLnI_7p13a)
  pdf("L1FLnI_7p13a CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_7p13a, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_7p13a Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_7p13a, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$ERVLB4_17q25.3b <- as.numeric(herv_table_cd4a$ERVLB4_17q25.3b)
  pdf("ERVLB4_17q25.3b CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = ERVLB4_17q25.3b, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("ERVLB4_17q25.3b Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = ERVLB4_17q25.3b, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_16q12.1b <- as.numeric(herv_table_cd4a$L1FLnI_16q12.1b)
  pdf("L1FLnI_16q12.1b CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_16q12.1b, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_16q12.1b Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_16q12.1b, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$MER34B_4q31.3 <- as.numeric(herv_table_cd4a$MER34B_4q31.3)
  pdf("MER34B_4q31.3 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = MER34B_4q31.3, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("MER34B_4q31.3 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = MER34B_4q31.3, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERV4_4q22.1 <- as.numeric(herv_table_cd4a$HERV4_4q22.1)
  pdf("HERV4_4q22.1 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERV4_4q22.1, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERV4_4q22.1 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERV4_4q22.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERVH_2q24.1e <- as.numeric(herv_table_cd4a$HERVH_2q24.1e)
  pdf("HERVH_2q24.1e CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERVH_2q24.1e, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERVH_2q24.1e Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERVH_2q24.1e, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HARLEQUIN_10q23.1 <- as.numeric(herv_table_cd4a$HARLEQUIN_10q23.1)
  pdf("HARLEQUIN_10q23.1 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HARLEQUIN_10q23.1, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)  + xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HARLEQUIN_10q23.1 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HARLEQUIN_10q23.1, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$MER41_16q21 <- as.numeric(herv_table_cd4a$MER41_16q21)
  pdf("MER41_16q21 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = MER41_16q21, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("MER41_16q21 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = MER41_16q21, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1q23.1s <- as.numeric(herv_table_cd4a$L1FLnI_1q23.1s)
  pdf("L1FLnI_1q23.1s CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1q23.1s Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HERV3_7q33 <- as.numeric(herv_table_cd4a$HERV3_7q33)
  pdf("HERV3_7q33 CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HERV3_7q33, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HERV3_7q33 Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HERV3_7q33, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_18q12.3x <- as.numeric(herv_table_cd4a$L1FLnI_18q12.3x)
  pdf("L1FLnI_18q12.3x CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_18q12.3x, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_18q12.3x Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_18q12.3x, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_11q13.4d <- as.numeric(herv_table_cd4a$L1FLnI_11q13.4d)
  pdf("L1FLnI_11q13.4d CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_11q13.4d, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_11q13.4d Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_11q13.4d, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_2q33.1g <- as.numeric(herv_table_cd4a$L1FLnI_2q33.1g)
  pdf("L1FLnI_2q33.1g CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_2q33.1g, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_2q33.1g Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_2q33.1g, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$HARLEQUIN_7q33a <- as.numeric(herv_table_cd4a$HARLEQUIN_7q33a)
  pdf("HARLEQUIN_7q33a CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = HARLEQUIN_7q33a, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("HARLEQUIN_7q33a Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = HARLEQUIN_7q33a, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1q23.3b <- as.numeric(herv_table_cd4a$L1FLnI_1q23.3b)
  pdf("L1FLnI_1q23.3b CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1q23.3b, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1q23.3b Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1q23.3b, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_Xq21.1db <- as.numeric(herv_table_cd4a$L1FLnI_Xq21.1db)
  pdf("L1FLnI_Xq21.1db CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_Xq21.1db, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_Xq21.1db Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_Xq21.1db, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_9p21.1ha <- as.numeric(herv_table_cd4a$L1FLnI_9p21.1ha)
  pdf("L1FLnI_9p21.1ha CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_9p21.1ha, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_9p21.1ha Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_9p21.1ha, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_5q32n <- as.numeric(herv_table_cd4a$L1FLnI_5q32n)
  pdf("L1FLnI_5q32n CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_5q32n, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_5q32n Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_5q32n, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_5q32o <- as.numeric(herv_table_cd4a$L1FLnI_5q32o)
  pdf("L1FLnI_5q32o CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_5q32o, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_5q32o Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_5q32o, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_8q21.3da <- as.numeric(herv_table_cd4a$L1FLnI_8q21.3da)
  pdf("L1FLnI_8q21.3da CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_8q21.3da, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_8q21.3da Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_8q21.3da, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_7q31.1ta <- as.numeric(herv_table_cd4a$L1FLnI_7q31.1ta)
  pdf("L1FLnI_7q31.1ta CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_7q31.1ta, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_7q31.1ta Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_7q31.1ta, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_3q26.31h <- as.numeric(herv_table_cd4a$L1FLnI_3q26.31h)
  pdf("L1FLnI_3q26.31h CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_3q26.31h, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_3q26.31h Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_3q26.31h, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1p31.1nc <- as.numeric(herv_table_cd4a$L1FLnI_1p31.1nc)
  pdf("L1FLnI_1p31.1nc CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1p31.1nc, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl")+ stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1p31.1nc Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1p31.1nc, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_4p13m <- as.numeric(herv_table_cd4a$L1FLnI_4p13m)
  pdf("L1FLnI_4p13m CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_4p13m, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_4p13m Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_4p13m, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_6q22.31z <- as.numeric(herv_table_cd4a$L1FLnI_6q22.31z)
  pdf("L1FLnI_6q22.31z CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_6q22.31z, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_6q22.31z Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_6q22.31z, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_7q21.13c <- as.numeric(herv_table_cd4a$L1FLnI_7q21.13c)
  pdf("L1FLnI_7q21.13c CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_7q21.13c, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_7q21.13c Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_7q21.13c, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_11p14.1v <- as.numeric(herv_table_cd4a$L1FLnI_11p14.1v)
  pdf("L1FLnI_11p14.1v CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_11p14.1v, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_11p14.1v Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_11p14.1v, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_11p14.1v <- as.numeric(herv_table_cd4a$L1FLnI_11p14.1v)
  pdf("L1FLnI_11p14.1v CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_11p14.1v, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
...
herv_table_cd4a$L1FLnI_4q21.21x <- as.numeric(herv_table_cd4a$L1FLnI_4q21.21x)
  ...
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_4q21.21x, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_4q21.21x Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_4q21.21x, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_5q21.3q <- as.numeric(herv_table_cd4a$L1FLnI_5q21.3q)
  pdf("L1FLnI_5q21.3q CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_5q21.3q, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_5q21.3q Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_5q21.3q, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_2q32.1k <- as.numeric(herv_table_cd4a$L1FLnI_2q32.1k)
  pdf("CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_2q32.1k, col = disease )) + geom_point() + theme_bw()  + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_2q32.1k Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_2q32.1k, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
herv_table_cd4a$L1FLnI_1p31.1l <- as.numeric(herv_table_cd4a$L1FLnI_1p31.1l)
  pdf("CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=CD4blood, y = L1FLnI_1p31.1l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)+ xlab("CD4+ Cells/μl") + stat_cor(method = "spearman")
    dev.off()
  pdf("L1FLnI_1p31.1l Viral Load.pdf")
  ggplot(herv_table_cd4a, aes(x=viral_load, y = L1FLnI_1p31.1l, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("HIV-1 Copies/mL") + stat_cor(method = "spearman")
    dev.off()
```

#2 TEs of further interest
#TEs in which Spearman correlation for viral load possesses p value <0.05 and is reversal of the healthy control samples
#LTR19_12p13.31, L1FLnI_1q23.1s
...
pdf("LTR19_12p13.31 Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4colon, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "spearman")
    dev.off()
    
pdf("L1FLnI_1q23.1s Gut CD4 Counts.pdf")
  ggplot(herv_table_cd4a, aes(x=cd4colon, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Percent of CD45+ Cells") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut CD11c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub, aes(x=CD11cpos_mDCs_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD11c+ mDCs per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut CD11c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD11cpos_mDCs_per_gram_sub, aes(x=CD11cpos_mDCs_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD11c+ mDCs per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut CD1c- mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub, aes(x=CD1cneg_mDCs_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c- mDCs per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut CD1c- mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cneg_mDCs_per_gram_sub, aes(x=CD1cneg_mDCs_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c- mDCs per gram (colon)") + stat_cor(method = "spearman")
      dev.off()
```
...
pdf("LTR19_12p13.31 Gut CD1c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub, aes(x=CD1cpos_mDCs_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c+ mDCs per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut CD1c+ mDCs per gram.pdf")
  ggplot(herv_table_cd4a_CD1cpos_mDCs_per_gram_sub, aes(x=CD1cpos_mDCs_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD1c+ mDCs per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD4_T_Cells_per_gram_sub, aes(x=cd4_T_Cells_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD4_T_Cells_per_gram_sub, aes(x=cd4_T_Cells_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD8_T_Cells_per_gram_sub, aes(x=cd8_T_Cells_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD8+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_CD8_T_Cells_per_gram_sub, aes(x=cd8_T_Cells_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("CD8+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut IFNy-IL17+T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYnegIL17pos_CD4_T_Cells_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Gut IFNy-IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut IFNy-IL17+T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYnegIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYnegIL17pos_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Gut IFNy-IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut IFNy+ CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub, aes(x=IFNYpos_cd8_T_Cells_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+ CD8+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut IFNy+ CD8+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYpos_cd8_T_Cells_per_gram_sub, aes(x=IFNYpos_cd8_T_Cells_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+ CD8+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut IFNy+IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17neg_CD4_T_Cells_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut IFNy+IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17neg_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut IFNy+IL17+ T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17pos_CD4_T_Cells_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut IFNy+IL17+ T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IFNYposIL17pos_CD4_T_Cells_per_gram_sub, aes(x=IFNYposIL17pos_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IFNy+IL17+T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut IL22+IFNy-IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IL22+IFNy-IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut IL22+IFNy-IL17-T CD4+ T Cells per gram.pdf")
  ggplot(herv_table_cd4a_IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram_sub, aes(x=IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("IL22+IFNy-IL17-T CD4+ T Cells per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Serum IL-6.pdf")
  ggplot(herv_table_cd4a_IL6_sub, aes(x=IL6, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum IL-6") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Serum IL-6.pdf")
  ggplot(herv_table_cd4a_IL6_sub, aes(x=IL6, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum IL-6") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Serum LPS.pdf")
  ggplot(herv_table_cd4a_LPS_sub, aes(x=LPS, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum LPS") + stat_cor(method = "spearman")
    dev.off()
    
herv_table_cd4a_LPS_sub$L1FLnI_1q23.1s <- as.numeric(herv_table_cd4a_LPS_sub$L1FLnI_1q23.1s)
pdf("L1FLnI_1q23.1s Serum LPS.pdf")
  ggplot(herv_table_cd4a_LPS_sub, aes(x=LPS, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("Serum LPS") + stat_cor(method = "spearman")
    dev.off()
```
...
pdf("LTR19_12p13.31 Gut pDCs per gram.pdf")
  ggplot(herv_table_cd4a_pDCs_per_gram_sub, aes(x=pDCs_per_gram, y = LTR19_12p13.31, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("pDCs per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
...
pdf("L1FLnI_1q23.1s Gut pDCs per gram.pdf")
  ggplot(herv_table_cd4a_pDCs_per_gram_sub, aes(x=pDCs_per_gram, y = L1FLnI_1q23.1s, col = disease )) + geom_point() + theme_bw() + geom_smooth(method=lm)  + xlab("pDCs per gram (colon)") + stat_cor(method = "spearman")
    dev.off()
```

#Bar Charts LTR19_12p13.31 and L1FLnI_1q23.1s
```{r}
#LTR19_12p13.31, L1FLnI_1q23.1s
#Gut Data
pdf("Gut_LTR19_12p13.31.pdf", height = 6, width = 4)
...
##export 
write.csv(raw_herv_PBMC, "PBMC_Telescope_Output.csv", row.names=TRUE)
...
##PBMC Heatmaps
```{r}
ddsSigPBMC <- subset(resultsddsPBMC, padj < 0.05)
ddsSigPBMC <- subset(ddsSigPBMC, log2FoldChange >= 1 | log2FoldChange <= -1)
ddsSigPBMC <- as.data.frame(ddsSigPBMC)
#Sort in descending order
ddsSigPBMC <- ddsSigPBMC[order(ddsSigPBMC$log2FoldChange, decreasing=TRUE),]

sort

dfPBMC <- vst(ddsPBMC, blind = TRUE)
dfPBMCAll <- dfPBMC %>% assay(.)
dfPBMC <- dfPBMC[rownames(ddsSigPBMC),] %>% assay(.)

#Set color scale to match rest of data (HIVpos=blue, HIVneg=red)
annot_colors=list(disease=c(Control="#F0978D",PLWH="#63D7DE"))

pdf("Heatmap PBMC sig.pdf", height = 6, width = 4)
dfPBMC <- dfPBMC[, rownames(ddsfPBMCFormat)[order(ddsfPBMCFormat$disease)]]
pheatmap(dfPBMC, annotation_colors=annot_colors, scale="row",main = "HIVneg vs HIVpos PBMC",fontsize = 5, size = 35, show_colnames = FALSE, show_rownames = TRUE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = ddsfPBMCFormat[,"disease",drop = FALSE], color = hcl.colors(10000, "RdYlBu"))

dev.off()

pdf("Heatmap PBMC all.pdf", height = 6, width = 4)
dfPBMCAll_clust <- dfPBMCAll[, rownames(ddsfPBMCFormat)[order(ddsfPBMCFormat$disease)]]
pheatmap(dfPBMCAll_clust, annotation_colors=annot_colors, scale="row",main = "HIVneg vs HIVpos PBMC",fontsize = 10, size = 35, show_colnames = FALSE, show_rownames = FALSE, cluster_cols = FALSE, cluster_rows = FALSE, legend_labels = "Expression Z-score", annotation_col = ddsfPBMCFormat[,"disease",drop = FALSE], color = hcl.colors(10000, "RdYlBu"))
...
plot_contrast_STAT <- function(count_table, metadata,category, herv, title = "Selected Counts", group = "2-side"){
  ...
  colnames(count_hervs) <- c("HERV","Category")
  if(group == "2-side"){
  herv_plot <- ggplot(count_hervs, aes(x = Category, y = HERV, color = Category)) +stat_compare_means(method = "t.test", label = "p.format", label.x.npc = "middle", vjust = -1) + geom_boxplot(outlier.shape = NA)+ geom_jitter(size = 1, shape=16, position=position_jitter(0.2))+ stat_summary(fun.y=mean)+xlab(NULL)+ ylab(" Normalized Counts")+ggtitle(title)+theme(plot.title = element_text(size = 15, face = "bold"),axis.title=element_text(size=15,face="bold"),legend.title = element_text(size = 15,face="bold"),axis.text = element_text(size = 15),axis.text.x = element_text(angle = 60, vjust = 1, hjust=1))+ theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))}
  else{
    herv_plot <- ggplot(count_hervs, aes(x = Category, y = HERV, color = Category)) + geom_boxplot(outlier.shape = NA)+ geom_jitter(size = 1, shape=16, position=position_jitter(0.2))+ stat_summary(fun.y=mean)+xlab(NULL)+ ylab(" Normalized Counts")+ggtitle(title)+theme(plot.title = element_text(size = 15, face = "bold"),axis.title=element_text(size=15,face="bold"),legend.title = element_text(size = 15,face="bold"),axis.text = element_text(size = 15),axis.text.x = element_text(angle = 60, vjust = 1, hjust=1))+ theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))}
    ...
    herv_plot <- ggplot(count_hervs, aes(x = Category, y = HERV, color = Category)) + geom_boxplot(outlier.shape = NA)+ geom_jitter(size = 1, shape=16, position=position_jitter(0.2))+ stat_summary(fun.y=mean)+xlab(NULL)+ ylab(" Normalized Counts")+ggtitle(title)+theme(plot.title = element_text(size = 15, face = "bold"),axis.title=element_text(size=15,face="bold"),legend.title = element_text(size = 15,face="bold"),axis.text = element_text(size = 15),axis.text.x = element_text(angle = 60, vjust = 1, hjust=1))+ theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + stat_compare_means(method = "anova", label.y = -5)+ stat_compare_means(p.adjust.method = "bonferroni", method = "t.test", label = "p =", comparisons = my_comparisons) 
    
  }
  return(print(herv_plot))}
```

##Anova Testing with post hoc T Test on Interferome Data for ERE induction
```{r}
pdf("Sig Test LTR19_12p13.31.pdf", height = 6, width = 5)
plot_contrast_PAIR(dfSigIntMat, metadata = meta_int, category = "Library.Name", herv = "LTR19_12p13.31", title = "LTR19_12p13.31", group = "multiple")
dev.off()

pdf("Sig Test L1FLnI_1q23.1s.pdf", height = 6, width = 5)
plot_contrast_PAIR(dfSigIntMat, metadata = meta_int, category = "Library.Name", herv = "L1FLnI_1q23.1s", title = "L1FLnI_1q23.1s", group = "multiple")
dev.off()
```
...
#Gut
t_dtMat <- t(dtMat)
t_dtMat <- as.data.frame(t_dtMat)
t_dtMat <- merge(t_dtMat,ddsf, by="row.names",all.x=TRUE)
var.test(LTR19_12p13.31 ~ disease, data = t_dtMat)
var.test(L1FLnI_1q23.1s ~ disease, data = t_dtMat)

#PBMC
t_dtMat_PBMC <- t(dtMat_PBMC)
t_dtMat_PBMC <- as.data.frame(t_dtMat_PBMC)
t_dtMat_PBMC <- merge(t_dtMat_PBMC,ddsfPBMCFormat, by="row.names",all.x=TRUE)
var.test(LTR19_12p13.31 ~ disease, data = t_dtMat_PBMC)
var.test(L1FLnI_1q23.1s ~ disease, data = t_dtMat_PBMC)

#Interferome
t_dtMat_Int <- t(dfSigIntMat)
t_dtMat_Int <- as.data.frame(t_dtMat_Int)
t_dtMat_Int <- merge(ddsf_Interferome, t_dtMat_Int, by="row.names", all.x=TRUE)
bartlett.test(L1FLnI_1q23.1s ~ Library.Name, data = t_dtMat_Int)
bartlett.test(LTR19_12p13.31 ~ Library.Name, data = t_dtMat_Int)

```


#95% Confidence Interval and S Value Reporting for Spearman Correlations
```{r}
herv_table_HIVpos <- herv_table_cd4a %>% filter(viral_load > 1)
herv_table_HIVneg <- herv_table_cd4a %>% filter(viral_load < 1)


#Viral Load
cor.test(herv_table_HIVpos$viral_load, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)
spearman.ci(herv_table_HIVpos$viral_load, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$viral_load, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)
spearman.ci(herv_table_HIVpos$viral_load, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$viral_load, herv_table_HIVpos$L1FLnI_3q26.31h, method = "spearman", conf.level = 0.95)
spearman.ci(herv_table_HIVpos$viral_load, herv_table_HIVpos$L1FLnI_3q26.31h, conf.level = 0.95)

cor.test(herv_table_HIVpos$viral_load, herv_table_HIVpos$L1FLnI_4q21.21x, method = "spearman", conf.level = 0.95)
spearman.ci(herv_table_HIVpos$viral_load, herv_table_HIVpos$L1FLnI_4q21.21x, conf.level = 0.95)

#CD4 T Cells
cor.test(herv_table_HIVneg$cd4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$cd4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$cd4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$cd4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)


cor.test(herv_table_HIVneg$cd4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$cd4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$cd4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$cd4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

#CD8 T Cells
cor.test(herv_table_HIVneg$cd8_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$cd8_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$cd8_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$cd8_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)


cor.test(herv_table_HIVneg$cd8_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$cd8_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$cd8_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$cd8_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

#IFNy+CD8 T Cells
cor.test(herv_table_HIVneg$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)


cor.test(herv_table_HIVneg$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYpos_cd8_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)


#CD11c+ mDC Cells
cor.test(herv_table_HIVneg$CD11cpos_mDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$CD11cpos_mDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$CD11cpos_mDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$CD11cpos_mDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)


cor.test(herv_table_HIVneg$CD11cpos_mDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$CD11cpos_mDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$CD11cpos_mDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$CD11cpos_mDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

#pDCs
cor.test(herv_table_HIVneg$pDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$pDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$pDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$pDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)


cor.test(herv_table_HIVneg$pDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$pDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$pDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$pDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

#CD1c- mDCs
cor.test(herv_table_HIVneg$CD1cneg_mDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$CD1cneg_mDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$CD1cneg_mDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$CD1cneg_mDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)


cor.test(herv_table_HIVneg$CD1cneg_mDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$CD1cneg_mDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$CD1cneg_mDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$CD1cneg_mDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

#CD1c+ mDCs
cor.test(herv_table_HIVneg$CD1cpos_mDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$CD1cpos_mDCs_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$CD1cpos_mDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$CD1cpos_mDCs_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)


cor.test(herv_table_HIVneg$CD1cpos_mDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$CD1cpos_mDCs_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$CD1cpos_mDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$CD1cpos_mDCs_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)
...
#CD4T Cell Subsets L1FLnI_1q23.1s
```{r}
##IFNYnegIL17pos
cor.test(herv_table_HIVneg$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

##IFNYposIL17neg
cor.test(herv_table_HIVneg$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

##IFNYposIL17pos
cor.test(herv_table_HIVneg$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

##IL22pos
cor.test(herv_table_HIVneg$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)
```


#CD4T Cell Subsets LTR19_12p13.31
```{r}
##IFNYnegIL17pos
cor.test(herv_table_HIVneg$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYnegIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)

##IFNYposIL17neg
cor.test(herv_table_HIVneg$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYposIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)

##IFNYposIL17pos
cor.test(herv_table_HIVneg$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IFNYposIL17pos_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)

##IL22pos
cor.test(herv_table_HIVneg$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IL22posIFNYnegIL17neg_CD4_T_Cells_per_gram, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)
```

#Circulating Markers
```{r}
##LPS
cor.test(herv_table_HIVneg$LPS, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$LPS, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$LPS, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$LPS, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVneg$LPS, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$LPS, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$LPS, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$LPS, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)

##IL6
##LPS
cor.test(herv_table_HIVneg$IL6, herv_table_HIVneg$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IL6, herv_table_HIVneg$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVpos$IL6, herv_table_HIVpos$L1FLnI_1q23.1s, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IL6, herv_table_HIVpos$L1FLnI_1q23.1s, conf.level = 0.95)

cor.test(herv_table_HIVneg$IL6, herv_table_HIVneg$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVneg$IL6, herv_table_HIVneg$LTR19_12p13.31, conf.level = 0.95)

cor.test(herv_table_HIVpos$IL6, herv_table_HIVpos$LTR19_12p13.31, method = "spearman", conf.level = 0.95)

spearman.ci(herv_table_HIVpos$IL6, herv_table_HIVpos$LTR19_12p13.31, conf.level = 0.95)
```
